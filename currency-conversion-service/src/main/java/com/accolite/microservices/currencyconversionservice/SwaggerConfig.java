package com.accolite.microservices.currencyconversionservice;
...
public class SwaggerConfig {
	  public static final Contact DEFAULT_CONTACT = new Contact("Basanta Kumar Sahu", "http://basantasahu", "mailforbasant@gmail.com");
